...
def run():
    ...
    try:
        ...
        if os.environ['creds_vpc_id'] == '' or os.environ['creds_vpc_id'] == 'PUT_YOUR_VALUE_HERE':
            try:
                ...
                if not local("~/scripts/%s.py %s" % ('create_vpc', params)):
                    with open("/root/result.json", 'w') as result:
        ...
        if os.environ['creds_subnet_id'] == '' or os.environ['creds_subnet_id'] == 'PUT_YOUR_VALUE_HERE':
            try:
                ...
                if not local("~/scripts/%s.py %s" % ('create_subnet', params)):
                    with open("/root/result.json", 'w') as result:
        ...
        if os.environ['creds_security_groups_ids'] == '' or os.environ['creds_security_groups_ids'] == 'PUT_YOUR_VALUE_HERE':
            try:
                ...
                if not local("~/scripts/%s.py %s" % ('create_security_group', params)):
                    with open("/root/result.json", 'w') as result:
        ...
        if not local("~/scripts/%s.py %s" % ('create_role_policy', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('create_endpoint', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('create_bucket', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('create_instance', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('install_prerequisites', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('configure_ssn', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('configure_docker', params)):
            with open("/root/result.json", 'w') as result:
    ...
    try:
        ...
        if not local("~/scripts/%s.py %s" % ('configure_ui', params)):
            with open("/root/result.json", 'w') as result:
