...
if __name__ == "__main__":
    ...
    reply['response']['log'] = "/var/log/dlab/emr/emr_{}_{}.log".format(os.environ['edge_user_name'], os.environ['request_id'])

    with open("/response/emr_{0}_{1}.json".format(os.environ['edge_user_name'], os.environ['request_id']), 'w') as response_file:
