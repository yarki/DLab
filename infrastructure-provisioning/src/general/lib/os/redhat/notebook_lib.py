...
def install_tensor(os_user, tensorflow_version, files_dir):
    if not exists('/home/' + os_user + '/.ensure_dir/tensor_ensured'):
        try:
            ...
            put(files_dir + 'tensor_tensorboard-python2.service', '/tmp/tensorboard-python2.service')
            put(files_dir + 'tensor_tensorboard-python3.service', '/tmp/tensorboard-python3.service')
