...
def ensure_pkg(user, requisites='linux-headers-generic python-pip python-dev groff gcc vim less git wget sysv-rc-conf libssl-dev unattended-upgrades nmap'):
    try:
