...
if __name__ == "__main__":
    ...
    if os.environ['general_resource'] == 'ssn':
        ...
        reply['response']['log'] = "/var/log/dlab/{0}/{0}_{1}_{2}.log".format(os.environ['resource'], os.environ['edge_user_name'], os.environ['request_id'])

        with open("/response/{}_{}_{}.json".format(os.environ['resource'], os.environ['edge_user_name'], os.environ['request_id']), 'w') as response_file:
            response_file.write(json.dumps(reply))
