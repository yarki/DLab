...
public class TerminateExploratoryEnvironmentParameters implements DockerRunParameters {
    ...
    private TerminateExploratoryEnvironmentParameters(Builder builder) {
    ...
    public static Builder newTerminateExploratoryEnvironmentParameters() {
        return new Builder();
    }
    ...
    public static final class Builder {
        ...
        public TerminateExploratoryEnvironmentParameters build() {
            return new TerminateExploratoryEnvironmentParameters(this);
        }
